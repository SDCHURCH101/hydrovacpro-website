...
VER  = "19"  # bump to cache-bust styles.css / app.js
...
# Downloadable one-page capability statement (generated by make_capability_pdf.py — run it after editing facts above)
PDF_CAP = "assets/hydrovac-pro-capability-statement.pdf"
...
<section class="capstmt" id="capability-statement">
  <div class="wrap">
    {heading}
    <div class="cap-download">
      <a class="btn btn-orange btn-lg" href="{PDF_CAP}?v={VER}" target="_blank" rel="noopener">{icon('doc')} Download Capability Statement (PDF)</a>
      <span class="cap-download-note">One page · every code, NAICS &amp; point of contact · ready for your solicitation file</span>
    </div>
    ...
    <div class="cap-foot">
      ...
      <div class="cap-note">
        <h3>On request</h3>
        <p>Our one-page capability statement is ready to download above. A W-9, certificate of insurance, references and past performance, and bonding capacity are available to qualified buyers.</p>
        <div class="cap-cta">
          <a class="btn btn-orange" href="{PDF_CAP}?v={VER}" target="_blank" rel="noopener">{icon('doc')} Download PDF</a>
          <a class="btn btn-outline" href="mailto:{POC_EMAIL}?subject=Capability%20statement%20request">{icon('mail')} Email {POC_NAME.split()[0]}</a>
