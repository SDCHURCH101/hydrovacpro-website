...
VER  = "5"  # bump to cache-bust styles.css / app.js
...
def page_index():
    ...
    return h + f"""
<section class="hero">
  <div class="hero-bg"><img src="assets/img/hero.jpg" alt="Hydrovac Pro truck excavating with its boom deployed into the ground on an Alaska job site" fetchpriority="high" width="1800" height="1350"></div>
